...
INSERT INTO `PLlibres`.`trabajador` (`cod_trabajador`, `nombre`, `apellido1`, `apellido2`, `telefono`, `correo`, `DNI`, `user`, `password`) VALUES 
(1,"Estefania","Colombo","Rosario",650668915, "estefania.c.r@t-systems.com", 481615178,"estcolros","pass123");
INSERT INTO `PLlibres`.`trabajador` (`cod_trabajador`, `nombre`, `apellido1`, `apellido2`, `telefono`, `correo`, `DNI`, `user`, `password`) VALUES 
(2,"Cristina","Cano","Porta",633668915, "cristinacp@t-systems.com", 654615178,"cricanpor","pass321");
INSERT INTO `PLlibres`.`trabajador` (`cod_trabajador`, `nombre`, `apellido1`, `apellido2`, `telefono`, `correo`, `DNI`, `user`, `password`) VALUES  
(3,"Sara","Fernandez","Tomi",656898915, "saraft@t-systems.com", 498715178,"sarfertom","pass456");
INSERT INTO `PLlibres`.`trabajador` (`cod_trabajador`, `nombre`, `apellido1`, `apellido2`, `telefono`, `correo`, `DNI`, `user`, `password`) VALUES 
(4,"Victor","Fernandez","Lopez",656898123, "victorfl@t-systems.com", 569715178,"vicferlop","pass654");
INSERT INTO `PLlibres`.`trabajador` (`cod_trabajador`, `nombre`, `apellido1`, `apellido2`, `telefono`, `correo`, `DNI`, `user`, `password`) VALUES  
(5,"David","Torres","Garcia",591398915, "davidtg@t-systems.com", 498716379,"davtorgar","pass789");
INSERT INTO `PLlibres`.`trabajador` (`cod_trabajador`, `nombre`, `apellido1`, `apellido2`, `telefono`, `correo`, `DNI`, `user`, `password`) VALUES  
(6,"Pepe","Torres","Garcia",981398915, "pepetg@t-systems.com", 498896379,"ptorgar","pass777");
...
INSERT INTO `PLlibres`.`voto` (`opinion`, `calificacion`, `cod_voto`,`cod_ejemplar`) 
VALUES ("Muy interesante",9, 1,2);
INSERT INTO `PLlibres`.`voto` (`opinion`, `calificacion`, `cod_voto`,`cod_ejemplar`) 
VALUES ("Muy aburrido",2, 2,3);
INSERT INTO `PLlibres`.`voto` (`opinion`, `calificacion`, `cod_voto`,`cod_ejemplar`) 
VALUES ("Muy aburrido",2, 3,1);
INSERT INTO `PLlibres`.`voto` (`opinion`, `calificacion`, `cod_voto`,`cod_ejemplar`) 
VALUES ("Interesante",5, 4,3);
INSERT INTO `PLlibres`.`voto` (`opinion`, `calificacion`, `cod_voto`,`cod_ejemplar`)  
VALUES ("Pesimo",0, 6,1);

-- Registros de prueba en tabla ejemplar
INSERT INTO `PLlibres`.`ejemplar` (`estado`, `cod_ejemplar`, `cod_libro`, `cod_sede`, `trabajador_presta`)
VALUES (10,1,2,3,1);
INSERT INTO `PLlibres`.`ejemplar` (`estado`, `cod_ejemplar`, `cod_libro`, `cod_sede`, `trabajador_presta`)
VALUES (10, 2, 1,2,1);
INSERT INTO `PLlibres`.`ejemplar` (`estado`, `cod_ejemplar`, `cod_libro`, `cod_sede`, `trabajador_presta`)
...
INSERT INTO `PLlibres`.`prestamo` (`cod_prestamo`, `fecha_caducidad`, `fecha_alta`, `fecha_devolucion`,   `cod_ejemplar`, `trabajador_recibe`, `trabajador_presta`) 
VALUES (1, "2021-01-01","2021-01-01" ,"2021-01-01",  1, 1,4);
INSERT INTO `PLlibres`.`prestamo` (`cod_prestamo`, `fecha_caducidad`, `fecha_alta`, `fecha_devolucion`,   `cod_ejemplar`, `trabajador_recibe`, `trabajador_presta`)
VALUES (2, "2021-01-01","2021-01-02" ,"2021-02-01",  1,2,3);
INSERT INTO `PLlibres`.`prestamo` (`cod_prestamo`, `fecha_caducidad`, `fecha_alta`, `fecha_devolucion`,  `cod_ejemplar`, `trabajador_recibe`, `trabajador_presta`) 
VALUES (3, "2021-01-01","2021-01-03" ,"2021-02-01", 3,  3,2);
INSERT INTO `PLlibres`.`prestamo` (`cod_prestamo`, `fecha_caducidad`, `fecha_alta`, `fecha_devolucion`,  `cod_ejemplar`, `trabajador_recibe`, `trabajador_presta`)
VALUES (4, "2021-01-01","2021-01-04" ,"2021-02-01", 2, 4,1);
INSERT INTO `PLlibres`.`prestamo` (`cod_prestamo`, `fecha_caducidad`, `fecha_alta`, `fecha_devolucion`, `cod_ejemplar`, `trabajador_recibe`, `trabajador_presta`)
VALUES (5, "2021-01-01","2021-01-04" ,"2021-02-01", 1, null,3);
INSERT INTO `PLlibres`.`prestamo` (`cod_prestamo`, `fecha_caducidad`, `fecha_alta`, `fecha_devolucion`,   `cod_ejemplar`, `trabajador_recibe`, `trabajador_presta`) 
VALUES (6, "2021-01-01","2021-01-01" ,"2021-01-01",  6, 1,6);
...
-- Registros de prueba en tabla usuario
INSERT INTO usuario (id, username, password) values( '1', 'admin', '$2a$10$XURPShQNCsLjp1ESc2laoObo9QZDhxz73hJPaEv7/cBha4pk0AgP.');
